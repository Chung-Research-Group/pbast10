...
- Only SHA-256 digests of the legacy and current 256-bit administrator
  tokens are committed to this public repository. Netlify may also hold a
  temporary rotation digest in `PBAST10_ADMIN_TOKEN_SHA256`.
...
- Remove `PBAST10_ADMIN_TOKEN_SHA256` after a temporary rotation digest has
  been promoted through a reviewed code change.
